...
#include "../src/moca_param.h"
#include "../src/comp_helpers.h"

void mocaUnpack(char *blob);
...
void test_moca_unpack()
{
	int len=0;
	char subdocfile[64] = "../../tests/moca.bin";
...
void add_suites( CU_pSuite *suite )
{
    *suite = CU_add_suite( "tests", NULL, NULL );
    CU_add_test( *suite, "test_moca_unpack", test_moca_unpack);
}
