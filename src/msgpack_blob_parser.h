...
enum {
    MSGPACK_OK = 0,
    MSGPACK_OUT_OF_MEMORY,
    MSGPACK_INVALID_ELEMENT,
    MSGPACK_MISSING_WRAPPER,
    MSGPACK_UNPACK_FAILED
};

typedef int (*process2_fn_t)(void *, int, ...);
typedef void (*destroy2_fn_t)(void *);
